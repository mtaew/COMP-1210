...
/** 
 * Compares the name of cardholder.
 *
 * @return name of compared cardholder 
 * @param cardholders takes Cardholder
 **/
   public int compareTo(Cardholder cardholders) {
      return name.compareToIgnoreCase(cardholders.getName());
   }
}
