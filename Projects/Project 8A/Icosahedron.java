...
public class Icosahedron {
   ...
   public String toString() {
    ...
    /**
     * A static method that accepts no parameters and returns an int
     * representing the static count field.  
     *
     * @return count
     */
   ...
   public static void resetCount() {
     ...
     * and returns false if the Object is a not an Icosahedron;
     * otherwise, when cast to an Icosahedron, if it has the same
     * field values as the Icosahedron upon which the method was called.
     * Otherwise, it returns false.
     *
     * @return false if not equal to the object else true.
   ...
   public boolean equals(Object obj) {
    ...
    /**
     * Accepts no parameters and returns zeroof type int.
     * 
     * @return 0
     */
   public int hashCode() {
